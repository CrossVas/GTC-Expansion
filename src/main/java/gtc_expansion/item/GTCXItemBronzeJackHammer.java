...
public class GTCXItemBronzeJackHammer extends ItemElectricTool implements IMiningDrill, IStaticTexturedItem {

	public GTCXItemBronzeJackHammer() {
		super(0.0F, -3.0F, ToolMaterial.DIAMOND);
        this.tier = 1;
        this.attackDamage = 1.0F;
        this.maxCharge = 10000;
        this.transferLimit = 100;
        this.setRegistryName("bronze_jackhammer");
        this.setUnlocalizedName(GTCExpansion.MODID + "." + "bronze_jackhammer");
