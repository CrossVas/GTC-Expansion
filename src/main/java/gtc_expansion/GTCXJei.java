...
public class GTCXJei {
    public static void initJei(){
        ...
        GTJeiHandler.addEntry(new GTJeiEntry(GTCXRecipeLists.COMPRESSOR_RECIPE_LIST, GTCXBlocks.stoneCompressor, GTCXMachineGui.GTCXStoneCompressorGui.class, 78, 24, 20, 18));
        GTJeiHandler.addEntry(new GTJeiEntry(GTCXRecipeLists.EXTRACTOR_RECIPE_LIST, GTCXBlocks.stoneExtractor, GTCXMachineGui.GTCXStoneExtractorGui.class, 78, 24, 20, 18));
    }
}
