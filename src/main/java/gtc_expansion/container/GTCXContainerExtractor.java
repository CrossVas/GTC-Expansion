...
public class GTCXContainerExtractor extends ContainerTileComponent<GTCXTileStoneExtractor> {
	...
	public GTCXContainerExtractor(InventoryPlayer player, GTCXTileStoneExtractor tile) {
		super(tile);
