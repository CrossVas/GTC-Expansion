...
public class GTCXContainerCompressor extends ContainerTileComponent<GTCXTileStoneCompressor> {
	...
	public GTCXContainerCompressor(InventoryPlayer player, GTCXTileStoneCompressor tile) {
		super(tile);
